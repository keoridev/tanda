    ...
    steps: [
      {
        ...
        duration: '3-4 недели',
        description: 'Изучение базовых технологий: HTML5, CSS3 и JavaScript (ES6+)',
        skills: ['HTML5', 'CSS3', 'Адаптивный дизайн', 'Git basics', 'DevTools'],
        resources: [
      ...
      },
      {
        ...
        duration: '5-6 недель',
        description: 'Глубокая работа с JavaScript: асинхронность, ООП, работа с API',
      ...
      },
      {
        ...
        duration: '6-8 недель',
        description: 'Изучение React 18+, управление состоянием, Next.js и TypeScript',
        skills: ['React', 'Redux/Toolkit', 'Next.js', 'TypeScript', 'React Query'],
        resources: [
      ...
      },
      {
        ...
        skills: ['Performance', 'Testing (Jest/RTL)', 'SSR/SSG', 'GraphQL', 'Web Vitals'],
        resources: [
          { name: 'Web Dev (Learn Performance)', url: 'https://web.dev/learn/' },
      ...
      },
      {
        ...
        duration: '4 недели',
        description: 'Создание портфолио, решение задач, подготовка к собеседованиям',
        skills: ['Портфолио', 'GitHub', 'LeetCode', 'System Design', 'Soft Skills'],
        resources: [
          { name: 'Frontend Interview Handbook', url: 'https://frontendinterviewhandbook.com' },
          { name: 'LeetCode Frontend', url: 'https://leetcode.com/explore/interview/card/top-interview-questions-easy/' }
        ]
      }
    ]
  },
    ...
    steps: [
      {
        ...
        skills: ['Python/Node.js', 'Базовые алгоритмы', 'Git', 'CLI', 'HTTP basics'],
        resources: [
      ...
      },
      {
        ...
        skills: ['Express.js', 'Django/FastAPI', 'JWT Auth', 'WebSockets', 'GraphQL'],
        resources: [
      ...
      },
      {
        ...
        duration: '5 недель',
        description: 'Деплой приложений, CI/CD и работа с облачными платформами',
      ...
      },
      {
        ...
        skills: ['SQL оптимизация', 'API Security', 'System Design', 'Scaling', 'Interview Prep'],
        resources: [
  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        duration: '5 недель',
        description: 'Работа с данными и их визуализация с помощью современных инструментов',
        skills: ['Pandas', 'Matplotlib', 'Seaborn', 'EDA', 'SQL для анализа'],
        resources: [
          { name: 'Data Visualization with Python', url: 'https://www.coursera.org/learn/python-for-data-visualization' },
      ...
      },
      {
        ...
        skills: ['Scikit-learn', 'TensorFlow/PyTorch', 'Feature Engineering', 'Model Evaluation', 'MLOps basics'],
        resources: [
      ...
      },
      {
        ...
        resources: [
          { name: 'Big Data with PySpark', url: 'https://www.udemy.com/course/spark-and-python-for-big-data-with-pyspark' },
      ...
      },
      {
        ...
        skills: ['Kaggle Competitions', 'Портфолио', 'AB Testing', 'Data Storytelling', 'Case Interviews'],
        resources: [
    ...
    steps: [
      {
        ...
        duration: '4 недели',
        description: 'Работа с Linux, bash-скриптинг и основы сетевых технологий',
        skills: ['Linux CLI', 'Bash scripting', 'Networking', 'SSH', 'Systemd'],
        resources: [
          { name: 'Linux Journey', url: 'https://linuxjourney.com' },
          { name: 'Cisco Networking Basics', url: 'https://www.netacad.com/courses/networking' }
        ]
      },
      {
        id: 'devops-2',
      ...
      },
      {
        ...
        skills: ['GitHub Actions', 'ArgoCD', 'Terraform', 'Ansible', 'Monitoring'],
        resources: [
      ...
      },
      {
        ...
        skills: ['Security Best Practices', 'Cost Optimization', 'Performance Tuning', 'Disaster Recovery', 'GitOps'],
        resources: [
          { name: 'DevSecOps Guide', url: 'https://www.devsecops.org' },
          { name: 'Cloud Cost Optimization', url: 'https://www.cncf.io/blog/2023/03/15/cloud-cost-optimization-best-practices/' }
        ]
      },
      {
        id: 'devops-5',
        ...
        skills: ['Case Studies', 'AWS/GCP Cert Prep', 'Incident Management', 'Interview Prep', 'SRE Principles'],
        resources: [
    ...
    steps: [
      {
        ...
        skills: ['Color Theory', 'Typography', 'Grid Systems', 'Design Principles', 'Figma Basics'],
        resources: [
      ...
      },
      {
        ...
        duration: '5 недель',
        description: 'Проведение исследований и создание пользовательских сценариев',
        skills: ['User Research', 'Personas', 'User Flows', 'Wireframing', 'Usability Testing'],
        resources: [
      ...
      },
      {
        ...
        skills: ['Figma', 'Design Systems', 'Prototyping', 'Microinteractions', 'Responsive Design'],
        resources: [
          { name: 'Figma UI Design', url: 'https://www.figma.com/resources/learn-design/' },
      ...
      },
      {
        ...
        skills: ['After Effects', '3D Design', 'AR/VR', 'Design Tokens', 'Accessibility'],
        resources: [
      ...
      },
      {
        ...
        skills: ['Case Studies', 'Portfolio Design', 'Networking', 'Freelance', 'Interview Prep'],
        resources: [
