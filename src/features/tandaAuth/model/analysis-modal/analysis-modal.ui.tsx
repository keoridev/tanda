      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className="bg-white rounded-3xl p-8 max-w-md w-full mx-4 border border-gray-200 shadow-xl"
          >
            {/* Header */}
            <div className="text-center mb-8">
              <motion.div
                ...
                className="w-20 h-20 bg-[#0c7d70] rounded-full flex items-center justify-center mx-auto mb-6"
              >
            ...
            <div className="mb-8">
              <div className="w-full bg-gray-200 rounded-full h-2 mb-4">
                <motion.div
                  ...
                  className="bg-[#0c7d70] h-2 rounded-full transition-all duration-300"
                />
              </div>
                ...
                >
                  ...
                  {progress >= (index + 1) * 25 && (
                    <motion.div
                      ...
                      className="ml-auto"
                    >
                      <CheckCircle className="text-[#0c7d70]" />
                    </motion.div>
                  )}
                </motion.div>
              ))}
            ...
            <div className="text-center">
              <motion.div
                ...
                className="w-8 h-8 border-2 border-[#0c7d70] border-t-transparent rounded-full mx-auto mb-2"
              />
